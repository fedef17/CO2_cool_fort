...
real(dp), parameter :: E_fun   = 667.3799_dp       ! Energy of CO2 fundamentsl band
real(dp), parameter :: cp_0    = 1.005e7_dp
real(dp), parameter :: kb      = kboltz*1e4_dp
real(dp), parameter :: kbc     = kboltz/(hplanck*clight*1e-13_dp) !  0.695035
real(dp), parameter :: Nave5   = 1e5_dp * Nav
...
!-------------------------------------------------------------------------
real(dp), parameter :: a_zo  = 3.5e-13_dp, b_zo  = 2.32e-9_dp, g_zo  = 76.75_dp 
real(dp), parameter :: a_zn2 = 7e-17_dp,   b_zn2 = 6.7e-10_dp, g_zn2 = 83.8_dp 
real(dp), parameter :: a_zo2 = 7e-17_dp,   b_zo2 = 1.0e-9_dp,  g_zo2 = 83.8_dp
...
integer, parameter :: n_lev_rf   = 51 ! lower level recurrence formula (has to be smaller than n_lev_cm)
integer, parameter :: n_lev_cm   = 55 ! upper level curtis matrix
integer, parameter :: n_lev_ru   = 65 ! upper level region 2 of recurrence formula
integer, parameter :: n_lev_cs   = 80 ! lower level cooling to space
